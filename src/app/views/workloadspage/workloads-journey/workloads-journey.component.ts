...
@Component({
  selector: 'app-workloads-journey',
  templateUrl: './workloads-journey.component.html',
  styleUrls: ['./workloads-journey.component.scss']
})
export class WorkloadsJourneyComponent implements OnInit, AfterViewInit, AfterViewChecked {
  INITIAL_INDEX = 0
  selectedIndex: number = this.INITIAL_INDEX;
  @Input('workloadJourney') workloadJourney: any;
